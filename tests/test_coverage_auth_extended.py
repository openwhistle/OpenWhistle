...
# ─── LDAP: existing but deactivated account ──────────────────────────────────
...
# ─── login_mfa_post: pending user no longer exists ───────────────────────────
...
# ─── mfa/setup: pending user no longer exists ────────────────────────────────
...
# ─── OIDC routes: enabled authorize + callback branches ──────────────────────

...
# ─── index: redirect once setup is complete ──────────────────────────────────
...
# ─── submit_get: location step downgraded once locations are removed ─────────
...
# ─── submit_post: location step validation ────────────────────────────────────
...
# ─── submit_post: review step with incomplete session state ──────────────────
...
# ─── submit_post: unrecognised step restarts the wizard ──────────────────────
...
# ─── status_get: naive submitted_at is treated as UTC ─────────────────────────
...
# ─── reply_post: no session/credentials, empty content, content too long ─────
...
# ─── whistleblower attachment download: bytes missing (LookupError) ──────────
